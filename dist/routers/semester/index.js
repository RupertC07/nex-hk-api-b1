...
const semesterController_1 = __importDefault(require("../../controllers/semester/semesterController"));
const apiKey_1 = __importDefault(require("../../middlewares/apiKey"));
// import AdminMiddleware from "../../middlewares/admin";
const auth_1 = require("../../middlewares/auth");
const client_1 = require("@prisma/client");
const semRouter = (0, express_1.Router)();
const semController = new semesterController_1.default();
/**
 * @swagger
 * tags:
 ...
 *                   example: 500
 */
semRouter.post("/", apiKey_1.default, (0, auth_1.authToken)([client_1.UserRole.admin]), semController.create);
/**
 * @swagger
 * tags:
 *   name: Semester Management
 ...
 *                   example: 500
 */
semRouter.put("/activate/:id", apiKey_1.default, (0, auth_1.authToken)([client_1.UserRole.admin]), semController.activate);
/**
 * @swagger
 * tags:
 *   name: Semester Management
 ...
 *                   example: 500
 */
semRouter.put("/deactivate", apiKey_1.default, (0, auth_1.authToken)([client_1.UserRole.admin]), semController.deactivate);
/**
 * @swagger
 * tags:
 *   - name: Semester Management
 ...
 *                   example: 500
 */
semRouter.put("/:id", apiKey_1.default, (0, auth_1.authToken)([client_1.UserRole.admin]), semController.update);
/**
 * @swagger
 * tags:
 *   name: Semester Management
 ...
 *                   example: 500
 */
semRouter.get("/", apiKey_1.default, (0, auth_1.authToken)([client_1.UserRole.admin]), semController.list);
/**
 * @swagger
 * tags:
 *   name: Semester Management
 ...
 *                   example: 500
 */
semRouter.get("/active", apiKey_1.default, (0, auth_1.authToken)([client_1.UserRole.admin]), semController.showActive);
/**
 * @swagger
 * /api/v2/semesters/{id}:
 *   get:
 ...
 *                   example: 500
 */
semRouter.get("/:id", apiKey_1.default, (0, auth_1.authToken)([client_1.UserRole.admin]), semController.show);
/**
 * @swagger
 * /api/v2/semesters/{id}:
 *   delete:
 ...
 *                   example: 500
 */
semRouter.delete("/:id", apiKey_1.default, (0, auth_1.authToken)([client_1.UserRole.admin]), semController.delete);
exports.default = semRouter;
