...
adminRoute.use((0, express_session_1.default)({
    secret: index_1.default.session.secret, // Replace with your actual secret key
    resave: false,
    saveUninitialized: true,
    cookie: { maxAge: index_1.default.session.age },
}));
/**
 * @swagger
 * tags:
 ...
 *                   example: 401
 */
adminRoute.post("/authenticate", apiKey_1.default, session_1.sessionCheck, adminController.auth);
/**
 * @swagger
 * tags:
 ...
 *                   example: 429
 */
adminRoute.post("/verification/:verification_id", apiKey_1.default, session_1.checkSessionOtp, adminController.verifyAuth);
/**
 * @swagger
 * tags:
 ...
 *                   example: 500
 */
adminRoute.put("/reset/verification/:verification_id", apiKey_1.default, session_1.sessionResetValidation, adminController.resetVerification);
/**
 * @swagger
 * tags:
 *   name: Admin Profile
 ...
 *                   example: 500
 */
adminRoute.get("/profile", apiKey_1.default, (0, auth_1.authToken)([client_1.UserRole.admin]), adminController.get);
/**
 * @swagger
 * tags:
 *   name: Admin Profile
 ...
 *                   example: 500
 */
adminRoute.post("/update", apiKey_1.default, (0, auth_1.authToken)([client_1.UserRole.admin]), adminController.update);
/**
 * @swagger
 * tags:
 *   name: Admin Profile
 ...
 *                   example: 500
 */
adminRoute.post("/change-password", apiKey_1.default, (0, auth_1.authToken)([client_1.UserRole.admin]), adminController.changePassword);
